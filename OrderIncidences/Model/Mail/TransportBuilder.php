...
namespace Orienteed\OrderIncidences\Model\Mail;
...
class TransportBuilder extends \Magento\Framework\Mail\Template\TransportBuilder
{
    ...
    protected function prepareMessage()
    {
        ...
        $partsArray = count($this->parts) ? array_merge([$mimePart], $this->parts) : [$mimePart];
    ...
    private function createMimePart(
        ...
        $mimePart = $this->mimePartInterfaceFactory->create(
            ['content' => $content, 'type' => $type, 'disposition' => $disposition, 'encoding' => $encoding, 'fileName' => $filename]
        );
